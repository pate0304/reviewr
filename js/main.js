var app = {
    ...
    init: function (ev) {
        ...
        document.querySelector("#backl").setAttribute("data-href", "listreview");
        document.querySelector("#backl").addEventListener("click", app.navigate);
    ...
    saveData: function (ev) {
        ...
        sendparams.append("uuid", "pate0304");
